...
import PostClubComponent from './PostClubComponent'; 

const MessageModalClub = ({
    isModalVisible,
    closeModal,
    messageText,
    setMessageText,
            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    <ScrollView contentContainerStyle={styles.scrollViewContainer}>
                        {post && (
                            <PostClubComponent post={post} style={styles.postStyle}/>
                        )}
                        <TextInput
...
export default MessageModalClub;
